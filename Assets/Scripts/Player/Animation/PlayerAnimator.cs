...
public class PlayerAnimator : MonoBehaviour
{
    ...
    public void SetSpeed(float speed) => _animator.SetFloat(_speedId, speed);
    public void SetGrounded(bool isGrounded) => _animator.SetBool(_groundedId, isGrounded);
    public void TriggerAttack() => _animator.SetTrigger(_attackId);
}
